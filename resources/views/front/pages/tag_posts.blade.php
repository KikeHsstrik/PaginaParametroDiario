...
<div class="row">
    ...
    <div class="col-lg-8 mb-5 mb-lg-0">
        <div class="row">
            ...
            @empty
                <span class="text-danger">¡No se encontraron noticias para esta categoría!</span>
            @endforelse
        </div>
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-body">
                            <img loading="lazy" decoding="async" src="/front/images/news.jpeg" alt=""
                                class="w-100 author-thumb-sm d-block">
                            <h2 class="widget-title my-3">"Parámetro Diario, la agencia de noticias que marca la diferencia".</h2>
                            <p class="mb-3 pb-2">"La información más importante en tus manos, gracias a Parámetro Diario".</p> <a
