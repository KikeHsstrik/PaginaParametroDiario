...
<div class="container">  
  <div class="row">
    <div class="container-fluid col-lg-12 paddding mb-2">
      <div class="container-fluid paddding ">
        ...
        <div class="row mx-0">
          ...
          @if(ocho_columnas1()->count() > 0)
          <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
          @foreach(ocho_columnas1() as $item)
          <div class="fh5co_suceefh5co_height"> 
            <img loading="lazy" decoding="async" src="/storage/images/post_images/thumbnails/thumb_{{$item->featured_image}}" alt="Post Thumbnail">
          <div class="fh5co_suceefh5co_height_position_absolute"> </div>
          <div class="fh5co_suceefh5co_height_position_absolute_font">
          
          
            <a class="font-weight-bold text-light" href="{{ route('read_post',$item->post_slug) }}" >
           <div class="post-info">
          
             <span class="carr-text font-weight-bold text-white">  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(253, 247, 247, 1);transform: ;msFilter:;"><path d="M13 3h4v2h-4zM3 8h4v2H3zm0 8h4v2H3zm-1-4h3.99v2H2zm19.707-5.293-1.414-1.414L18.586 7A6.937 6.937 0 0 0 15 6c-3.859 0-7 3.141-7 7s3.141 7 7 7 7-3.141 7-7a6.968 6.968 0 0 0-1.855-4.73l1.562-1.563zM16 14h-2V8.958h2V14z">
            </path></svg>{{ date_formatter(single_latest_post()->created_at) }}</span>
            <h5 class="text-white fh5co_good_font">{{ $item->post_title }}</h5>
          ...
          @endif
                ...
                <div class="row">
                  ...
                  @if(ocho_columnas2()->count() > 0)
                  <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                  @foreach(ocho_columnas2() as $item)
                  ...
                  <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                   ...
                   <div class="post-info">
                    ...
                    <h5 class="text-white fh5co_good_font_2">{{ $item->post_title }}</h5>
...
@if(ocho_columnas3()->count() > 0)
<div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
@foreach(ocho_columnas3() as $item)
<div class="fh5co_suceefh5co_height_2"> 
  <img loading="lazy" decoding="async" src="/storage/images/post_images/thumbnails/thumb_{{$item->featured_image}}" alt="Post Thumbnail">
<div class="fh5co_suceefh5co_height_position_absolute"> </div>
<div class="fh5co_suceefh5co_height_position_absolute_font_2">
...
<div class="container">  
  <div class="row">
    <div class="container-fluid col-lg-12 paddding mb-5">
        
      <div class="row mx-0">
        
        <div class="col-lg-8 col-md-8 col-12">
          <h2 class="section-title mb-2">Mejores Noticias</h2>
          <div class="gallery js-flickity" data-flickity-options='{"wrapAround":true}'>
              @foreach(carrusel() as $item)
              <div class="gallery-cell">
                  <img  decoding="async" src="/storage/images/post_images/thumbnails/resized_{{$item->featured_image}}" alt="Post Thumbnail" class="w-100">
                  <div class="carousel-caption d-none d-md-block">
       
                      <h3 class="text-white font-weight-bold  bg-success">{{ $item->post_title }}</h3>
                      <p class="mb-0 text-md text-white">{!! Str::ucfirst(words($item->post_content,7)) !!}</p>
                  </div>
              </div>
              @endforeach
          </div>
           ...
           <div class="col-md-4 mt-5 col-12 paddding animate-box" data-animate-effect="fadeIn">
             <h2 class="section-title">Buenas Noticias</h2>
    ...
    <div class="col-lg-8 mb-5 mb-lg-0">
      <div class="row">
        <div class="col-12 mb-4">
          <h2 class="section-title text-center">Ultimas Noticias</h2>
  ...
  <div class="col-lg-12">
    <div class="widget">
      <div class="widget-body">
        ...
        <h5 class="widget-title my-3">Somos un medio de comunicación enfocado a crear contenido por y para líderes de opinión. </h5>
        <p class=" pb-2">
