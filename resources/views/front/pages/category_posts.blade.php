                ...
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-body">
                            <img loading="lazy" decoding="async" src="/front/images/entrevista-periodistas.jpg" alt="About Me"
                                class="w-100 author-thumb-sm d-block">
                            <h2 class="widget-title my-3">"Mantente informado de todo lo que ocurre en el mundo con Parámetro Diario".
                            </h2>
                            <p class="mb-3 pb-2">"Parámetro Diario, la fuente confiable de noticias que necesitas".</p> <a
...
<div class="">
    <div class="icon-bar">
        ...
        <a href="#" class="twitter"><svg xmlns="http://www.w3.org/2000/svg"  width="30" height="30"" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
        ...
        <a href="#" class="instagram"><svg xmlns="http://www.w3.org/2000/svg"  width="30" height="30" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
